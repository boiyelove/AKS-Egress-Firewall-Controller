...
Verify routing and source IP, approved and blocked FQDNs, direct-IP bypass prevention, TLS inspection exceptions, DNS failure, firewall failover, image pulls, upgrades, log completeness, and throughput.
